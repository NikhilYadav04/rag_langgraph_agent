...
from vectorstore import add_document, INDEX_NAME, pc
...
async def upload_document(file: UploadFile = File(...)):
    ...
    print(f"Received PDF for upload : {file.filename}. Saved temporarily")
    ...
    try:
        ...
        if os.path.exists(temp_file_path):
            ...
            print(f"Cleared up temporarily file : {temp_file_path}")
...
async def clear_index():
    # Take Pinecone Object and clear a specific index
    ...
    print("All records deleted from rag-index")
